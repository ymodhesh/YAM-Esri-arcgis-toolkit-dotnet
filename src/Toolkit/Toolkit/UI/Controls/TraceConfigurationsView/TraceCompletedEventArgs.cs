...
{
    /// <summary>
    /// Event argument used by <see cref="TraceConfigurationsView.TraceCompleted"/> event.
    /// </summary>
    public sealed class TraceCompletedEventArgs : EventArgs
    {
        internal TraceCompletedEventArgs(UtilityTraceParameters parameters, IEnumerable<UtilityTraceResult> results)
        {
            Parameters = parameters;
            Results = results;
        }

        internal TraceCompletedEventArgs(UtilityTraceParameters parameters, Exception error)
        {
            Parameters = parameters;
            Error = error;
        }
